...
namespace CCN.DashboardCustom
{
    ...
    public static class CollectionsExtensions
    {
        ...
        /// <param name="propertyStr">排序字段名</param>
        /// <param name="IsDesc">是否降序(默认升序)</param>
        /// <returns></returns>
        public static IQueryable<TEntity> ReflectionOrderBy<TEntity>(this IQueryable<TEntity> source, string propertyStr, bool IsDesc = false) where TEntity : class
        {
