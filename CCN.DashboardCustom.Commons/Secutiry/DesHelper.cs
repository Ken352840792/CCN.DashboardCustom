...
namespace CCN.DashboardCustom.Secutiry
{
    ...
    public class DesHelper
    {
        ...
        private const string SignKey = "eTHANHAn";
        ...
        /// <returns>加密的BASE64编码的字符串</returns>
        public static string Encrypt(string source, string key = null)
        {
            if (key == null)
            {
                key = SignKey;
        ...
        public static string Decrypt(string source, string key = null)
        {
            if (key == null)
            {
                key = SignKey;
        ...
        /// <param name="targetFile">保存加密文件名</param>
        /// <param name="key">密钥字符串，长度为8或者24</param>
        public static void EncryptFile(string sourceFile, string targetFile, string key = null)
        {
            if (key == null)
            {
                key = SignKey;
        ...
        /// <param name="sectionLength">分段大小（字节）</param>
        /// <param name="key">密钥字符串，长度为8或者24</param>
        public static void EncryptFile(string sourceFile, string targetFile, int sectionLength, string key = null)
        {
            if (key == null)
            {
                key = SignKey;
        ...
        /// <param name="targetFile">保存加密文件名</param>
        /// <param name="key">密钥字符串，长度为8或者24</param>
        public static void DecryptFile(string sourceFile, string targetFile, string key = null)
        {
            if (key == null)
            {
                key = SignKey;
